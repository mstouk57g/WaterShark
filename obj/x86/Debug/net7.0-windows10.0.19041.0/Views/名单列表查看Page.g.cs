...
namespace WaterShark.Views
{
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.UI.Xaml.Markup.Compiler"," 3.0.0.2310")]
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        private class 名单列表查看Page_obj7_Bindings :
            global::Microsoft.UI.Xaml.IDataTemplateExtension,
            global::Microsoft.UI.Xaml.Markup.IDataTemplateComponent,
            global::Microsoft.UI.Xaml.Markup.IXamlBindScopeDiagnostics,
            global::Microsoft.UI.Xaml.Markup.IComponentConnector,
            I名单列表查看Page_Bindings
        {
            ...
            public 名单列表查看Page_obj7_Bindings()
            {
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.UI.Xaml.Markup.Compiler"," 3.0.0.2310")]
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        private class 名单列表查看Page_obj1_Bindings :
            global::Microsoft.UI.Xaml.Markup.IDataTemplateComponent,
            global::Microsoft.UI.Xaml.Markup.IXamlBindScopeDiagnostics,
            global::Microsoft.UI.Xaml.Markup.IComponentConnector,
            I名单列表查看Page_Bindings
        {
            private global::WaterShark.Views.名单列表查看Page dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            private 名单列表查看Page_obj1_BindingsTracking bindingsTracking;

            public 名单列表查看Page_obj1_Bindings()
            {
                this.bindingsTracking = new 名单列表查看Page_obj1_BindingsTracking(this);
            }
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 12: // Views\名单列表查看Page.xaml line 86
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                ...
                if (newDataRoot != null)
                {
                    this.dataRoot = global::WinRT.CastExtensions.As<global::WaterShark.Views.名单列表查看Page>(newDataRoot);
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::WaterShark.Views.名单列表查看Page obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_ViewModel(global::WaterShark.ViewModels.名单列表查看ViewModel obj, int phase)
            {
            ...
            private void Update_ViewModel_SampleItems(global::System.Collections.ObjectModel.ObservableCollection<global::WaterShark.Core.Models.SampleOrder> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
                    // Views\名单列表查看Page.xaml line 86
            ...
            private void Update_ViewModel_Selected(global::WaterShark.Core.Models.SampleOrder obj, int phase)
            {
            ...
            private void UpdateTwoWay_12_SelectedItem()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        ...
                        {
                            this.dataRoot.ViewModel.Selected = (global::WaterShark.Core.Models.SampleOrder)this.obj12.SelectedItem;
                        }
                    }
                }
            }
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.UI.Xaml.Markup.Compiler"," 3.0.0.2310")]
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            private class 名单列表查看Page_obj1_BindingsTracking
            {
                private global::System.WeakReference<名单列表查看Page_obj1_Bindings> weakRefToBindingObj; 

                public 名单列表查看Page_obj1_BindingsTracking(名单列表查看Page_obj1_Bindings obj)
                {
                    weakRefToBindingObj = new global::System.WeakReference<名单列表查看Page_obj1_Bindings>(obj);
                }

                public 名单列表查看Page_obj1_Bindings TryGetBindingObject()
                {
                    名单列表查看Page_obj1_Bindings bindingObject = null;
                ...
                {
                    名单列表查看Page_obj1_Bindings bindings = TryGetBindingObject();
                    if (bindings != null)
                    {
                        string propName = e.PropertyName;
                        global::WaterShark.ViewModels.名单列表查看ViewModel obj = sender as global::WaterShark.ViewModels.名单列表查看ViewModel;
                ...
                private global::WaterShark.ViewModels.名单列表查看ViewModel cache_ViewModel = null;
                public void UpdateChildListeners_ViewModel(global::WaterShark.ViewModels.名单列表查看ViewModel obj)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            switch(connectionId)
            {
            case 11: // Views\名单列表查看Page.xaml line 72
                {
        ...
        public global::Microsoft.UI.Xaml.Markup.IComponentConnector GetBindingConnector(int connectionId, object target)
        {
            ...
            switch(connectionId)
            {
            case 1: // Views\名单列表查看Page.xaml line 1
                {                    
                    global::Microsoft.UI.Xaml.Controls.Page element1 = (global::Microsoft.UI.Xaml.Controls.Page)target;
                    名单列表查看Page_obj1_Bindings bindings = new 名单列表查看Page_obj1_Bindings();
            ...
            case 7: // Views\名单列表查看Page.xaml line 15
                {                    
                    ...
                    名单列表查看Page_obj7_Bindings bindings = new 名单列表查看Page_obj7_Bindings();
                    returnValue = bindings;
