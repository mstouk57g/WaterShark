#pragma checksum "F:\WaterShark\WaterShark\Views\名单列表查看DetailControl.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "94D9AFB4B85A12F13ED9A78443E59345237F815D84DD8004EB73533A03BB81D4"
//------------------------------------------------------------------------------
// <auto-generated>
...
{
    partial class 名单列表查看DetailControl : 
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.UI.Xaml.Markup.Compiler"," 3.0.0.2310")]
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        private class 名单列表查看DetailControl_obj1_Bindings :
            global::Microsoft.UI.Xaml.Markup.IDataTemplateComponent,
            global::Microsoft.UI.Xaml.Markup.IXamlBindScopeDiagnostics,
            global::Microsoft.UI.Xaml.Markup.IComponentConnector,
            I名单列表查看DetailControl_Bindings
        {
            private global::WaterShark.Views.名单列表查看DetailControl dataRoot;
            ...
            private 名单列表查看DetailControl_obj1_BindingsTracking bindingsTracking;

            public 名单列表查看DetailControl_obj1_Bindings()
            {
                this.bindingsTracking = new 名单列表查看DetailControl_obj1_BindingsTracking(this);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                ...
                if (newDataRoot != null)
                {
                    this.dataRoot = global::WinRT.CastExtensions.As<global::WaterShark.Views.名单列表查看DetailControl>(newDataRoot);
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::WaterShark.Views.名单列表查看DetailControl obj, int phase)
            {
            ...
            private void Update_ListDetailsMenuItem_Status(global::System.String obj, int phase)
            {
                ...
                {
                    // Views\名单列表查看DetailControl.xaml line 30
            ...
            private void Update_ListDetailsMenuItem_OrderDate(global::System.DateTime obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\名单列表查看DetailControl.xaml line 36
            ...
            private void Update_ListDetailsMenuItem_ShipTo(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\名单列表查看DetailControl.xaml line 47
            ...
            private void Update_ListDetailsMenuItem_OrderTotal(global::System.Double obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\名单列表查看DetailControl.xaml line 52
            ...
            private void Update_ListDetailsMenuItem_Symbol(global::System.Char obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\名单列表查看DetailControl.xaml line 15
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.UI.Xaml.Markup.Compiler"," 3.0.0.2310")]
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            private class 名单列表查看DetailControl_obj1_BindingsTracking
            {
                private global::System.WeakReference<名单列表查看DetailControl_obj1_Bindings> weakRefToBindingObj; 

                public 名单列表查看DetailControl_obj1_BindingsTracking(名单列表查看DetailControl_obj1_Bindings obj)
                {
                    weakRefToBindingObj = new global::System.WeakReference<名单列表查看DetailControl_obj1_Bindings>(obj);
                }

                public 名单列表查看DetailControl_obj1_Bindings TryGetBindingObject()
                {
                    名单列表查看DetailControl_obj1_Bindings bindingObject = null;
                ...
                {
                    名单列表查看DetailControl_obj1_Bindings bindings = TryGetBindingObject();
                    if (bindings != null)
                    {
                        global::WaterShark.Views.名单列表查看DetailControl obj = sender as global::WaterShark.Views.名单列表查看DetailControl;
                        if (obj != null)
                        {
                ...
                public void UpdateChildListeners_(global::WaterShark.Views.名单列表查看DetailControl obj)
                {
                    名单列表查看DetailControl_obj1_Bindings bindings = TryGetBindingObject();
                    if (bindings != null)
                    {
                        ...
                        {
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::WaterShark.Views.名单列表查看DetailControl.ListDetailsMenuItemProperty, tokenDPC_ListDetailsMenuItem);
                        }
                        if (obj != null)
                        {
                            bindings.dataRoot = obj;
                            tokenDPC_ListDetailsMenuItem = obj.RegisterPropertyChangedCallback(global::WaterShark.Views.名单列表查看DetailControl.ListDetailsMenuItemProperty, DependencyPropertyChanged_ListDetailsMenuItem);
                        }
                    }
                }
            }
        ...
        public void Connect(int connectionId, object target)
        {
            switch(connectionId)
            {
            case 2: // Views\名单列表查看DetailControl.xaml line 8
                {
        ...
        public global::Microsoft.UI.Xaml.Markup.IComponentConnector GetBindingConnector(int connectionId, object target)
        {
            ...
            switch(connectionId)
            {
            case 1: // Views\名单列表查看DetailControl.xaml line 1
                {                    
                    global::Microsoft.UI.Xaml.Controls.UserControl element1 = (global::Microsoft.UI.Xaml.Controls.UserControl)target;
                    名单列表查看DetailControl_obj1_Bindings bindings = new 名单列表查看DetailControl_obj1_Bindings();
